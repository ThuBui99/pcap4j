  ...
  public static void main(String[] args) throws PcapNativeException, NotOpenException {
    ...
    PacketListener listener = new PacketListener() {
      ...
      public void gotPacket(Packet packet) {
        ...
        System.out.println("ip source       : " + ipPacket.getHeader().getDstAddr().getHostAddress()); // get dst addr
        System.out.println("ip destination  : "+ipPacket.getHeader().getSrcAddr().getHostAddress()); // get src addr
